...
contract CrutradeEcosystemTest is Test {
    ...
    function test_WrapperImportExport() public {
        ...
        // Import wrapper
        vm.startPrank(operational);
        IWrappers.Wrapper[] memory wrapperData = new IWrappers.Wrapper[](1);
        wrapperData[0] = IWrappers.Wrapper({
        ...
        IWrappers.Wrapper memory imported = wrappers.getWrapperData(0);
        ...
        IWrappers.Wrapper memory exported = wrappers.getWrapperData(0);
    ...
    function test_MultipleCollections() public {
        ...
        IWrappers.Wrapper[] memory wrapperData = new IWrappers.Wrapper[](3);
        wrapperData[0] = IWrappers.Wrapper({
            uri: "https://example.com/metadata/1",
            metaKey: "item_001",
            amount: 0,
        ...
        wrapperData[1] = IWrappers.Wrapper({
        ...
        wrapperData[2] = IWrappers.Wrapper({
        ...
        IWrappers.Wrapper[] memory collectionA = wrappers.getCollectionData(keccak256("COLLECTION_A"));
        assertEq(collectionA.length, 2);
        
        IWrappers.Wrapper[] memory collectionB = wrappers.getCollectionData(keccak256("COLLECTION_B"));
