...
export class Memberships__factory {
  static readonly abi = _abi;
  static createInterface(): MembershipsInterface {
    return new Interface(_abi) as MembershipsInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): Memberships {
    return new Contract(address, _abi, runner) as unknown as Memberships;
  }
}
